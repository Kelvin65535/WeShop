...
services.factory('Order', ['$http', function ($http) {
    return {
         ...
         */
        getInfo: function (p) {
            return $http.get('/admin/Order/getOrderInfo/', {
                params: p
            }).error(function (ret) {
                _process_error(ret);
            });
         ...
         */
        getList: function (p) {
            return $http.get('/admin/Order/getOrderList/', {
                params: p
            }).error(function (ret) {
                _process_error(ret);
            });
        ...
        deleteOrder: function (p) {
            return $http.post('/admin/Order/deleteOrder/', $.param(p), {
        ...
        getExpressCompanys: function (p) {
            return $http.get('/admin/Order/getExpressCompanys/', {
                params: p
            }).error(function (ret) {
                _process_error(ret);
            });
